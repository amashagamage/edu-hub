    ...
    <>
      ...
      <div
        className={`w-full transition-all duration-300 relative ${
          isScrolled
            ? "bg-gradient-to-r from-black to-green-600 shadow-lg"
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-6 py-4 relative z-10">
              ...
              <Link
                ...
                className={`p-2 rounded-full transition-colors relative ${
                  isActive("/notifications")
                    ...
                    : "text-white/90 hover:bg-green-200 hover:text-white"
                }`}
              >
          ...
          <div className="hidden md:block">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full transition-all duration-200 bg-green-100 border border-green-300 text-black font-medium px-5 py-1.5 hover:bg-green-200"
            >
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="p-2 rounded-lg text-white hover:bg-green-200 transition-colors"
            >
              {mobileMenuOpen ? (
                <X className="w-6 h-6" />
              ) : (
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="bg-black shadow-xl py-2 px-4 space-y-1">
            <Link
              to={"/"}
              className={`block px-4 py-3 rounded-lg ${
                isActive("/")
                  ? "bg-green-200 text-white font-medium"
                  : "text-white/90 hover:bg-green-200 hover:text-white"
              }`}
            ...
            <div className="px-4 py-3">
              <Link
                to={isLoggedIn ? "/profile" : "/login"}
                className="block w-full text-center bg-green-100 border border-green-300 text-black font-medium px-6 py-2 rounded-lg hover:bg-green-200 transition-colors"
                onClick={() => setMobileMenuOpen(false)}
              >
                {isLoggedIn ? "Profile" : "Login"}
              </Link>
