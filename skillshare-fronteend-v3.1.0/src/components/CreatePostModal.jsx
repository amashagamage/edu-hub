  ...
  return (
    <>
      <button
        ...
        className="mt-6 mb-12 w-full flex justify-center items-center gap-2 py-3 px-4 border border-transparent rounded-lg shadow-md text-sm font-medium text-white bg-gradient-to-r from-black to-green-600 hover:from-black hover:to-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all transform hover:scale-[1.02]"
      >
      ...
      >
        ...
        <div className="border-b border-gray-200">
          <div className="flex justify-between items-center px-6 py-4 bg-gradient-to-r from-black to-green-600 text-white">
            <h2 className="text-xl font-bold">Create New Post</h2>
            <button
              onClick={() => setIsOpen(false)}
              className="text-white hover:text-white/80 bg-green-700 hover:bg-green-800 rounded-full p-2 transition-colors"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="block w-full border border-gray-300 rounded-lg shadow-sm py-3 px-4 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
                />
              </div>
          ...
          {currentTab === "options" && (
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="flex">
                  <div className="flex items-center px-3 bg-black border border-r-0 border-gray-300 rounded-l-lg text-white">
                  ...
                  <input
                    ...
                    className="flex-grow border border-gray-300 rounded-r-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                  />
                </div>
              </div>
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="px-6 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-black to-green-600 hover:from-black hover:to-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
